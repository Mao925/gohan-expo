...
type LikeToggleButtonProps = {
  ...
  onToggle?: (nextStatus: "YES" | "NO") => void;
  disabled?: boolean;
  isLoading?: boolean;
};

export function LikeToggleButton({ status, onToggle, disabled, isLoading }: LikeToggleButtonProps) {
  const isYes = status === "YES";
  const nextStatus: "YES" | "NO" = isYes ? "NO" : "YES";
